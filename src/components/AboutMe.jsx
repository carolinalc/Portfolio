  ...
  return (
    <div className='aboutme'>
      ...
      <p className='name'>Carolina López</p>
        <hr />
      <h4>Full Stack Web Developer  <br /> // Javascript(ES6), React, ExpressJS,
          NodeJS, MongoDB, Html5, Css & Bootstrap WDFT // </h4> <br />
        <hr />
      ...
      <Card.Body>
        ...
        <Card.Title>Linkedin:  <Nav.Link href="https://www.linkedin.com/in/carolina-lopez-webdev/">https://www.linkedin.com/in/carolina-lopez-webdev/</Nav.Link></Card.Title>
      </Card.Body>
    </Card>
    <hr />
    </div>
