        ...
        <Card className="text-center">
          ...
          <Card.Body>
            <Card.Text>
              ...
              <strong><Nav.Link href="https://carolinalc.github.io/proyecto-1/"> Lets try here</Nav.Link></strong>
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="text-center">
          ...
          <Card.Body>
            <Card.Text>
              ...
              <Nav.Link href="https://vinegar-trainer.herokuapp.com/."><strong>Check the web</strong></Nav.Link>
            </Card.Text>
          </Card.Body>
        </Card>
